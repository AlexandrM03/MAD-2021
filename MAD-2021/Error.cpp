...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(306, "[ SEMANTIC ] Объявление переменной без указания типа"),																	
		...
		ERROR_ENTRY(312, "[ SEMANTIC ] Несоответствие типов данных"),																
		...
		ERROR_ENTRY(315, "[ SEMANTIC ] Несоответствие количества передаваемых параметров функции"),						
		ERROR_ENTRY(316, "[ SEMANTIC ] Попытка переопределить переменную"),						
		ERROR_ENTRY(317, "[ SEMANTIC ] Недопустимое значение"),						
		...
		ERROR_ENTRY(609, "[ SYNTAX ] Ошибка в выражении"),
		ERROR_ENTRY(610, "[ SYNTAX ] Ошибка в списке параметров при вызове функции"),
		ERROR_ENTRY(611, "[ SYNTAX ] Ошибка в выражении"),
